...
class Hei extends Model
{
    ...
    {
        $heiregion = DB::table('tbl_heis')->select('hei_region_nir')->groupBy('hei_region_nir')->get();
    ...
    public function getHeiProvinces($heiregion)
    {
        ...
        $heiprovince = DB::table('tbl_heis')->select('hei_prov_name')->groupBy('hei_prov_name')->where('hei_region_nir', $hei_region_nir)->get();
    ...
    public static function showHei($heiregion, $heiprov, $heitype)
    {
        ...
        $hei = DB::table('tbl_heis')->select('hei_region_nir')->addSelect('hei_prov_name')->addSelect('hei_shortname')->addSelect('hei_it')->addSelect('hei_ct')->where('hei_it', 'like', '%' . $hei_it . '%')->where('hei_region_nir', '=', $hei_region_nir)->where('hei_prov_name', '=', $heiprov)->get();
